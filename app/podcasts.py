...
#region imports for image manipulation
try:
    import imagekit
...
from app.models import Channel, Show, Episode
from django.conf import settings

pdsettings = (('PODCASTING_FEED_ENTRIES', settings.PODCASTING_FEED_ENTRIES or None), ('PAGINATE_BY', settings.PAGINATE_BY or 10),)
